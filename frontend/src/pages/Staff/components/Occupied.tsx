...
function formatDuration(seconds: number): string {
  ...
  const pastTime = new Date(seconds * 1000);
        ...
        <div className="mt-6 w-4/5 md:w-1/2 mb-20">
          <Stack direction="column" spacing={2.5}>
            ...
            {status?.map((item, index) => {
              ...
              const isWarn =
                formattedDuration.includes("d") &&
                parseInt(formattedDuration.split(" ")[0], 10) > 7;
              return (
                <CommonButton
                  key={index}
                  onClick={() =>
                  ...
                  bgcolor={isWarn ? "#E65345" : undefined}
                  bordercolor={isWarn ? "#000000" : undefined}
                >
                  <Grid
                    container
                    spacing={0}
