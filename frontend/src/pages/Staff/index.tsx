        ...
        <div className=''>
          ...
          {isStaffRoute && (
            <div className='flex flex-col items-center justify-start'>
              ...
              <div className="flex flex-col sm:flex-row md:mb-1 text-2xl md:text-2xl text-blue-dark font-bold
              justify-center sm:justify-around align-middle items-center w-4/5 sm:mb-2">
                ...
                <div className='flex flex-col justify-center items-center sm:flex-row gap-1 sm:gap-5 text-center sm:ml-1'>
                  <div >
                    <span className='text-yellow underline decoration-yellow-dark text-sm md:text-xl lg:text-2xl mr-1'>6
                    </span>                    
                  ...
                  <div>
                    <span className='text-blue underline decoration-blue-dark text-sm md:text-xl lg:text-2xl mr-1'>2
                    </span>                      
                    <span className='text-xs md:text-md lg:text-lg'>
