...
export default function UsageRatio() {
  ...
  return (
    <div className='flex flex-col items-center justify-start' style={{ height: '88vh' }}>
      <div className="mt-8 md:mt-6 md:mb-2 text-2xl md:text-2xl text-blue-dark font-bold flex flex-col sm:flex-row sm:justify-around align-middle items-center w-4/5">
        <div className="hidden sm:flex">Usage Ratio</div>
        <div className='flex md:w-2/5 gap-12 md:gap-9 mt-2 md:mt-0 mb-2 md:mb-0'>
          <SelectedLotMenu />
          <SelectedFloorMenu />
        </div>
      </div>
