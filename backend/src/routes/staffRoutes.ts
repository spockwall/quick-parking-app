...
staffRouter.get("/parking_spaces", verifyAdminAndGuardAndStaff, staffGetParkingSpaces)
staffRouter.get("/parking_spaces/:userId", verifyUserId, staffGetParkingSpaceByUid)
