...
mockedPrismaClient.prototype.user.findUnique = jest.fn().mockImplementation((args) => {
...
mockedEncryptUtils.comparePswd = jest.fn().mockImplementation((password: string, hashedPassword: string) => {
  return password === '123' && hashedPassword === '$2b$10$examplehashedpassword';
});
